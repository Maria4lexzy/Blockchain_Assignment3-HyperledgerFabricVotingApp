...
exports.connectToNetwork = async function (userName) {
  ...
  try {
    ...
    const contract = await network.getContract("vote_contract");
...
exports.registerVoter = async function (
  ...
  try {
    ...
    const cert =
      "-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n";
    const key =
      "-----BEGIN PRIVATE KEY-----\nMIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgNdn0Q2sGBNQxohb7\n4hSzCjKTP6sklHVbgeTs0APybPyhRANCAARWhRKGLV2tN09PriWD39dMnL2yr5Qo\nnlli3m9lgHJqi+QhbqVY4Nyn0mj2b+okHih6Xb5p5lBzlOy5DxBUFrJL\n-----END PRIVATE KEY-----\n";
